...
from model.ours.DNN import MAXCNN, MEANCNN
import numpy as np
...
class TAMPSTGCNCNN(nn.Module):
    ...
    def forward(self, x, x_window, node_embeddings, fixed_adj, adj, stay_cost, jump_cost, MPG):
        ...
        #S8: mutli-persistence representation learning
        ...
        #S9: combination operation
        x_tswconv = torch.cat([x_sconv, 1, x_wconv_t], dim = -1) + bias #(B, N, dim_out)
        return x_tswconv
