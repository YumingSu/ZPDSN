...
from model.ours.TAMPGCNETs import TAMPGCRNCNN as Network
from model.ours.Trainer import Trainer
from model.ours.TrainInits import init_seed
from model.ours.dataloader import get_topo_dataloader
from model.ours.dataloader import get_dataloader
from model.ours.TrainInits import print_model_parameters
from model.ours.TrainInits import get_memory_usage
from model.ours.metrics import MAE_torch
import os
...
Mode = 'train'
DEBUG = 'True'
DATASET = 'Temp' #Temp or Wind or Humidity or Cloud
DEVICE = 'cuda:0'
MODEL = 'WFGCNETs'
data_type = '3'
...
#load dataset
train_loader, val_loader, test_loader, scaler = get_topo_dataloader(args, data_type, normalizer=args.normalizer,
